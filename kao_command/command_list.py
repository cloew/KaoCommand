...
class CommandList:
    ...
    def __init__(self, scriptName, category=None):
    ...
    def buildProgramName(self, command):
        ...
        return "{0} {1}".format(self.scriptName, " ".join(programPieces))
    ...
    def help(self):
        ...
        print "Available {0} Categories".format(self.name)
    ...
    def description(self):
        ...
        return "List of {0} Commands".format(self.name)
